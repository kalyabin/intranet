 ...
 */
class Version20170607185935 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_notification (id BIGINT NOT NULL, receiver BIGINT NOT NULL, author BIGINT DEFAULT NULL, ticket BIGINT DEFAULT NULL, ticket_message BIGINT DEFAULT NULL, ticket_manager BIGINT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, "type" VARCHAR(20) NOT NULL, is_read BOOLEAN NOT NULL, PRIMARY KEY(id))');
