 ...
 */
class Version20170502201423 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_role (user_id BIGINT NOT NULL, code TEXT NOT NULL, PRIMARY KEY(user_id, code))');
